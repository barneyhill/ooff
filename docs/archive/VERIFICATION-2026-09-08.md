...
| Every iteration recorded for plotting | `benchmarks/NATIVE_ITERATIONS.md`, `benchmarks/iterations/summary.csv` | Includes failures/regressions and optional AVX-512 compiler failure. Per-query results and full outputs retained. All original final gates complete; new classic benchmark has its own iteration ledger. |
