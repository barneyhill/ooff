...
benchmark iterations are recorded in [BENCHMARKS.md](../../benchmarks/NATIVE_ITERATIONS.md).
...
[reference inputs](../reference.md) for the Ensembl 110 data choice.
...
![Measured ASO screening time including Sassy2](../images/classic-scaling.svg)
...
not been measured. See [summary semantics, limits and commands](../SUMMARY.md).
...
[Methods and reproducible EC2 jobs](../CLASSIC_BENCHMARK.md) ·
[Plot data](../images/classic-scaling.csv) ·
[Separate build time and memory data](../images/classic-index-builds.csv) ·
...
See [usage, scientific assumptions and verification](../DDG.md) and
...
expanding occurrences; see [algorithm and exactness argument](../ALGORITHM.md).
...
after all checks pass. See [release instructions](../RELEASING.md).

Site and whole-transcript ΔΔG use the Watt et al. convention: **off-target ΔG − intended-target ΔG** (kcal/mol); positive values indicate weaker off-target binding. Global site-energy caching is enabled by default; see [DDG documentation](../DDG.md).
