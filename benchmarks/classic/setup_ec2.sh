...
cp -a target/release/oofft-index data/classic-stage/saved-binaries/ooff-index-single-thread
...
python3 benchmarks/classic/command.py --label native-parallel-build --timeout 600 -- cargo build --locked --release --bin oofft-index
...
PY
sha256sum target/release/oofft-index > results/classic-setup.success
